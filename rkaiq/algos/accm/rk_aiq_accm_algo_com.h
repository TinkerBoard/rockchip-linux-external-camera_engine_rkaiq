...
XCamReturn interpCCMbywbgain(const CalibDbV2_Ccm_Para_V2_t *pCcm, accm_handle_t hAccm, float fSaturation);
XCamReturn selectCCM(const CalibDbV2_Ccm_Para_V2_t *pCcm, accm_handle_t hAccm, float fSaturation);
