...
XCamReturn rk_aiq_uapi_adrc_V10_SetAttrib(RkAiqAlgoContext* ctx, drcAttrV10_t attr,
                                          bool need_sync) {
    LOG1_ATMO("ENTER: %s \n", __func__);
...
XCamReturn rk_aiq_uapi_adrc_V10_GetAttrib(RkAiqAlgoContext* ctx, drcAttrV10_t* attr) {
    ...
    memcpy(&attr->Info, &pAdrcCtx->drcAttrV10.Info, sizeof(DrcInfo_t));
...
XCamReturn rk_aiq_uapi_adrc_V11_SetAttrib(RkAiqAlgoContext* ctx, drcAttrV11_t attr,
                                          bool need_sync) {
    LOG1_ATMO("ENTER: %s \n", __func__);
    AdrcContext_t* pAdrcCtx = (AdrcContext_t*)(ctx);
    XCamReturn ret          = XCAM_RETURN_NO_ERROR;
...
XCamReturn rk_aiq_uapi_adrc_V11_GetAttrib(RkAiqAlgoContext* ctx, drcAttrV11_t* attr) {
    ...
    memcpy(&attr->Info, &pAdrcCtx->drcAttrV11.Info, sizeof(DrcInfo_t));
...
XCamReturn rk_aiq_uapi_adrc_V12_SetAttrib(RkAiqAlgoContext* ctx, drcAttrV12_t attr,
                                          bool need_sync) {
    LOG1_ATMO("ENTER: %s \n", __func__);
    AdrcContext_t* pAdrcCtx = (AdrcContext_t*)(ctx);
    XCamReturn ret          = XCAM_RETURN_NO_ERROR;
...
XCamReturn rk_aiq_uapi_adrc_V12_GetAttrib(RkAiqAlgoContext* ctx, drcAttrV12_t* attr) {
    ...
    memcpy(&attr->Info, &pAdrcCtx->drcAttrV12.Info, sizeof(DrcInfo_t));
