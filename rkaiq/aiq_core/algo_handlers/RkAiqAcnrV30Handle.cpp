...
void RkAiqAcnrV30HandleInt::init() {
    ...
    mPreInParam   = (RkAiqAlgoCom*)(new RkAiqAlgoPreAcnrV30());
    mPreOutParam  = (RkAiqAlgoResCom*)(new RkAiqAlgoPreResAcnrV30());
    mProcInParam  = (RkAiqAlgoCom*)(new RkAiqAlgoProcAcnrV30());
    mProcOutParam = (RkAiqAlgoResCom*)(new RkAiqAlgoProcResAcnrV30());
    mPostInParam  = (RkAiqAlgoCom*)(new RkAiqAlgoPostAcnrV30());
    mPostOutParam = (RkAiqAlgoResCom*)(new RkAiqAlgoPostResAcnrV30());
...
XCamReturn RkAiqAcnrV30HandleInt::updateConfig(bool needSync) {
    ...
    if (updateStrength) {
        ...
        rk_aiq_uapi_acnrV30_SetChromaSFStrength(mAlgoCtx, mCurStrength.percent);
...
XCamReturn RkAiqAcnrV30HandleInt::setAttrib(rk_aiq_cnr_attrib_v30_t* att) {
    ENTER_ANALYZER_FUNCTION();
...
XCamReturn RkAiqAcnrV30HandleInt::setStrength(rk_aiq_cnr_strength_v30_t *pStrength) {
    ENTER_ANALYZER_FUNCTION();
...
XCamReturn RkAiqAcnrV30HandleInt::getStrength(rk_aiq_cnr_strength_v30_t *pStrength) {
    ...
    if(pStrength->sync.sync_mode == RK_AIQ_UAPI_MODE_SYNC) {
        mCfgMutex.lock();
        rk_aiq_uapi_acnrV30_GetChromaSFStrength(mAlgoCtx, &pStrength->percent);
