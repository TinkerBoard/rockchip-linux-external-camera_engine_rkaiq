...
#if RKAIQ_HAVE_MERGE_V10
XCamReturn RkAiqAmergeHandleInt::setAttribV10(mergeAttrV10_t att) {
    ENTER_ANALYZER_FUNCTION();
...
#if RKAIQ_HAVE_MERGE_V11
XCamReturn RkAiqAmergeHandleInt::setAttribV11(mergeAttrV11_t att) {
    ENTER_ANALYZER_FUNCTION();
...
#if RKAIQ_HAVE_MERGE_V12
XCamReturn RkAiqAmergeHandleInt::setAttribV12(mergeAttrV12_t att) {
    ENTER_ANALYZER_FUNCTION();
