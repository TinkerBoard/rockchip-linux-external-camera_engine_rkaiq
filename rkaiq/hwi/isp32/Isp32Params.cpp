...
#if 0
void Isp32Params::fixedAwbOveflowToIsp32Params(void* isp_cfg_p, bool is_dual_isp) {
    // in overfloce case :
    ...
    if (is_dual_isp == false) {
        ...
        if (w * h > RK_AIQ_AWB_STAT_MAX_AREA) {
            LOGD_AWB("%s wp_luma_wei is force to be enable and the weight is %d", __FUNCTION__,
        ...
        if (w * h > RK_AIQ_AWB_STAT_MAX_AREA || w2 * h2 > RK_AIQ_AWB_STAT_MAX_AREA) {
            LOGD_AWB("wp_luma_wei is for to be enable and the weight is %d",
                     (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1);
            left_awb_cfg_v30->sw_rawawb_wp_luma_wei_en0 = true;
            left_awb_cfg_v30->sw_rawawb_wp_luma_wei_en1 = true;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w0 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w1 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w2 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w3 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w4 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w5 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w6 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w7 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            left_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w8 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_wei_en0 = true;
            right_awb_cfg_v30->sw_rawawb_wp_luma_wei_en1 = true;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w0 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w1 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w2 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w3 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w4 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w5 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w6 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w7 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
            right_awb_cfg_v30->sw_rawawb_wp_luma_weicurve_w8 =
                (1 << RK_AIQ_AWB_WP_WEIGHT_BIS_V201) - 1;
...
void Isp32Params::convertAiqAwbToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
    ...
    awb_cfg_v30->sw_rawawb_wp_blk_wei_en0 =
    ...
    awb_cfg_v30->sw_rawawb_wp_luma_wei_en0 =
    ...
    awb_cfg_v30->sw_rawawb_multiwindow0_h_size =
        awb_meas.multiwindow[0][0] + awb_meas.multiwindow[0][2];
    awb_cfg_v30->sw_rawawb_multiwindow0_v_size =
    ...
    awb_cfg_v30->sw_rawawb_multiwindow1_h_size =
        awb_meas.multiwindow[1][0] + awb_meas.multiwindow[1][2];
    awb_cfg_v30->sw_rawawb_multiwindow1_v_size =
    ...
    awb_cfg_v30->sw_rawawb_multiwindow2_h_size =
        awb_meas.multiwindow[2][0] + awb_meas.multiwindow[2][2];
    awb_cfg_v30->sw_rawawb_multiwindow2_v_size =
    ...
    awb_cfg_v30->sw_rawawb_multiwindow3_h_size =
        awb_meas.multiwindow[3][0] + awb_meas.multiwindow[3][2];
    awb_cfg_v30->sw_rawawb_multiwindow3_v_size =
        awb_meas.multiwindow[3][1] + awb_meas.multiwindow[3][3];

#endif
    awb_cfg_v30->sw_rawawb_exc_wp_region0_excen0 =
        awb_meas.excludeWpRange[0].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region0_excen1 =
    ...
    awb_cfg_v30->sw_rawawb_exc_wp_region1_excen0 =
        awb_meas.excludeWpRange[1].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region1_excen1 =
    ...
    awb_cfg_v30->sw_rawawb_exc_wp_region2_excen0 =
        awb_meas.excludeWpRange[2].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region2_excen1 =
    ...
    awb_cfg_v30->sw_rawawb_exc_wp_region3_excen0 =
        awb_meas.excludeWpRange[3].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region3_excen1 =
    ...
    awb_cfg_v30->sw_rawawb_exc_wp_region4_excen0 =
        awb_meas.excludeWpRange[4].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region4_excen1 =
    ...
    awb_cfg_v30->sw_rawawb_exc_wp_region5_excen0 =
        awb_meas.excludeWpRange[5].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region5_excen1 =
    ...
    awb_cfg_v30->sw_rawawb_exc_wp_region6_excen0 =
        awb_meas.excludeWpRange[6].excludeEnable[RK_AIQ_AWB_XY_TYPE_NORMAL_V201];
    awb_cfg_v30->sw_rawawb_exc_wp_region6_excen1 =
...
void Isp32Params::convertAiqRawnrToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqTnrToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqUvnrToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqYnrToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqSharpenToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqGainToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
                                              rk_aiq_isp_gain_v3x_t& gain) {
    LOGD_ANR("%s:%d enter! enable:%d gain:0x%x 0x%x 0x%x\n", __FUNCTION__, __LINE__,
             gain.sw_gain_en, gain.sw_gain[0], gain.sw_gain[1], gain.sw_gain[2]);
...
void Isp32Params::convertAiqDrcToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqAfToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
                                            const rk_aiq_isp_af_meas_v3x_t& af_data,
                                            bool af_cfg_udpate) {
    int i;
    ...
    memcpy(isp_cfg.meas.rawaf.line_en, af_data.line_en,
           ISP2X_RAWAF_LINE_NUM * sizeof(unsigned char));
    ...
    memcpy(isp_cfg.meas.rawaf.gamma_y, af_data.gamma_y,
           ISP3X_RAWAF_GAMMA_NUM * sizeof(unsigned short));
...
void Isp32Params::convertAiqMergeToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqAgammaToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
    ...
    for (int i = 0; i < 49; i++) cfg->gamma_y[i] = gamma_out_cfg.Gamma_v30.gamma_y[i];
...
void Isp32Params::convertAiqCacToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
...
void Isp32Params::convertAiqAdehazeToIsp32Params(struct isp3x_isp_params_cfg& isp_cfg,
    ...
    for (int i = 0; i < ISP3X_DHAZ_HIST_WR_NUM; i++) cfg->hist_wr[i] = dhaze.ProcResV30.hist_wr[i];
...
bool Isp32Params::convert3aResultsToIspCfg(SmartPtr<cam3aResult>& result, void* isp_cfg_p) {
    ...
    switch (type) {
        ...
        case RESULT_TYPE_AWBGAIN_PARAM: {
            SmartPtr<RkAiqIspAwbGainParamsProxy> awb_gain =
                result.dynamic_cast_ptr<RkAiqIspAwbGainParamsProxy>();
            if (awb_gain.ptr()) {
                if (mBlcResult.ptr()) {
                    SmartPtr<RkAiqIspBlcParamsProxyV21> blc =
                        mBlcResult.dynamic_cast_ptr<RkAiqIspBlcParamsProxyV21>();
                    convertAiqAwbGainToIsp21Params(isp_cfg, awb_gain->data()->result,
                                                   &blc->data()->result, true);
                } else {
                    convertAiqAwbGainToIsp21Params(isp_cfg, awb_gain->data()->result, nullptr,
                                                   true);
                }
        ...
        case RESULT_TYPE_AWB_PARAM: {
            SmartPtr<RkAiqIspAwbParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspAwbParamsProxyV3x>();
            if (params.ptr()) convertAiqAwbToIsp32Params(isp_cfg, params->data()->result, true);
        } break;
        case RESULT_TYPE_DRC_PARAM: {
            SmartPtr<RkAiqIspDrcParamsProxy> params =
                result.dynamic_cast_ptr<RkAiqIspDrcParamsProxy>();
            if (params.ptr()) convertAiqDrcToIsp32Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_TNR_PARAM: {
            SmartPtr<RkAiqIspTnrParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspTnrParamsProxyV3x>();
            if (params.ptr()) convertAiqTnrToIsp32Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_RAWNR_PARAM: {
            SmartPtr<RkAiqIspBaynrParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspBaynrParamsProxyV3x>();
            if (params.ptr()) convertAiqRawnrToIsp32Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_YNR_PARAM: {
            SmartPtr<RkAiqIspYnrParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspYnrParamsProxyV3x>();
            if (params.ptr()) convertAiqYnrToIsp32Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_UVNR_PARAM: {
            SmartPtr<RkAiqIspCnrParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspCnrParamsProxyV3x>();
            if (params.ptr()) convertAiqUvnrToIsp32Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_SHARPEN_PARAM: {
            SmartPtr<RkAiqIspSharpenParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspSharpenParamsProxyV3x>();
        ...
        case RESULT_TYPE_GAIN_PARAM: {
            ...
            if (params.ptr()) convertAiqGainToIsp32Params(isp_cfg, params->data()->result);
        } break;
        ...
        case RESULT_TYPE_MERGE_PARAM: {
            ...
            if (params.ptr()) {
                convertAiqMergeToIsp32Params(isp_cfg, params->data()->result);
            }
        } break;
        case RESULT_TYPE_AGAMMA_PARAM: {
            SmartPtr<RkAiqIspAgammaParamsProxy> params =
                result.dynamic_cast_ptr<RkAiqIspAgammaParamsProxy>();
            if (params.ptr()) convertAiqAgammaToIsp32Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_CAC_PARAM: {
            SmartPtr<RkAiqIspCacParamsProxyV3x> params =
                result.dynamic_cast_ptr<RkAiqIspCacParamsProxyV3x>();
            if (params.ptr())
                convertAiqCacToIsp32Params(isp_cfg, isp_cfg_right, params->data()->result);
        } break;
        ...
        case RESULT_TYPE_BLC_PARAM: {
            SmartPtr<RkAiqIspBlcParamsProxyV21> params =
                result.dynamic_cast_ptr<RkAiqIspBlcParamsProxyV21>();
            if (params.ptr()) convertAiqBlcToIsp21Params(isp_cfg, params->data()->result);
        } break;
        case RESULT_TYPE_CCM_PARAM: {
            SmartPtr<RkAiqIspCcmParamsProxy> params =
                result.dynamic_cast_ptr<RkAiqIspCcmParamsProxy>();
            if (params.ptr()) convertAiqCcmToIsp21Params(isp_cfg, params->data()->result);
        } break;
#endif
        ...
        case RESULT_TYPE_DEBAYER_PARAM: {
            SmartPtr<RkAiqIspDebayerParamsProxy> params =
                result.dynamic_cast_ptr<RkAiqIspDebayerParamsProxy>();
            if (params.ptr()) convertAiqAdemosaicToIsp20Params(isp_cfg, params->data()->result);
        } break;
        ...
        case RESULT_TYPE_ADEGAMMA_PARAM: {
            SmartPtr<RkAiqIspAdegammaParamsProxy> params =
                result.dynamic_cast_ptr<RkAiqIspAdegammaParamsProxy>();
            if (params.ptr()) convertAiqAdegammaToIsp20Params(isp_cfg, params->data()->result);
        } break;
