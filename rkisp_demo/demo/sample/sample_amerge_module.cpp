...
XCamReturn sample_amerge_module(const void *arg)
{
    ...
    do {
        ...
        switch (
            key) { /*
                  case '0': {
                      printf("\t AMERGE test rk_aiq_user_api2_amerge_SetAttrib stManual
                  BASEFRAME_SHORT Sync\n\n"); attr.sync.sync_mode = RK_AIQ_UAPI_MODE_DEFAULT;
                      attr.sync.done = false;
                      attr.attrV30.opMode = MERGE_OPMODE_MANUAL;
                  ...
                  attr.attrV30.CtlInfo.Envlv, attr.attrV30.CtlInfo.MoveCoef); printf("\t BaseFrm:%d
                  \n\n", attr.attrV30.stManual.BaseFrm); printf("\t LongFrmModeData OECurve
                  Smooth:%f Offset:%f\n\n", attr.attrV30.stManual.LongFrmModeData.OECurve.Smooth,
                             attr.attrV30.stManual.LongFrmModeData.OECurve.Offset);
                      printf("\t LongFrmModeData MDCurve LM_smooth:%f LM_offset:%f MS_smooth%f
                  MS_offset:%f\n\n", attr.attrV30.stManual.LongFrmModeData.MDCurve.LM_smooth,
                             attr.attrV30.stManual.LongFrmModeData.MDCurve.LM_offset,
                  attr.attrV30.stManual.LongFrmModeData.MDCurve.MS_smooth,
                  ...
                  attr.attrV30.stManual.ShortFrmModeData.MDCurve.Coef,
                             attr.attrV30.stManual.ShortFrmModeData.MDCurve.ms_thd0,
                  attr.attrV30.stManual.ShortFrmModeData.MDCurve.lm_thd0); break;
                  }
                  default:
                      break;
                      */
