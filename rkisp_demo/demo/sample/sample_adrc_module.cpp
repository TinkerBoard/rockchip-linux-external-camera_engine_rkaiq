    ...
    do {
        ...
        switch (
            key) { /*
                  ...
                  case '6': {
                      printf("\t ADRC test rk_aiq_user_api2_adrc_SetAttrib stLocalDataV30
                  Sync\n\n"); attr.sync.sync_mode = RK_AIQ_UAPI_MODE_DEFAULT; attr.sync.done =
                  false; attr.opMode = DRC_OPMODE_LOCAL_TMO; attr.stLocalDataV30.LocalWeit = 1;
                  ...
                  case '7': {
                      printf("\t ADRC test rk_aiq_user_api2_adrc_SetAttrib stLocalDataV30
                  Async\n\n"); attr.sync.sync_mode = RK_AIQ_UAPI_MODE_ASYNC; attr.sync.done = false;
                  ...
                  attr.stManualV30.DrcGain.DrcGain, attr.stManualV30.DrcGain.Alpha,
                  attr.stManualV30.DrcGain.Clip); printf("\t stDrcGain DrcGain:%f Alpha:%f
                  Clip:%f\n\n", attr.stDrcGain.DrcGain, attr.stDrcGain.Alpha, attr.stDrcGain.Clip);
                      printf("\t stHiLit Strength:%f\n\n", attr.stHiLit.Strength);
                      printf("\t stLocalDataV30 LocalWeit:%f LocalAutoEnable:%d LocalAutoWeit:%f
                  GlobalContrast:%f LoLitContrast:%f\n\n", attr.stLocalDataV30.LocalWeit,
                             attr.stLocalDataV30.LocalAutoEnable, attr.stLocalDataV30.LocalAutoWeit,
                  attr.stLocalDataV30.GlobalContrast, attr.stLocalDataV30.LoLitContrast); break;
                  }
                  case '9': {
                  ...
                  &LocalAutoEnable, &LocalAutoWeit); printf("\t ADRC rk_aiq_uapi2_getDrcGain:
                  LocalWeit:%f GlobalContrast:%f LoLitContrast:%f LocalAutoEnable:%d
                  LocalAutoWeit:%f\n\n", LocalWeit, GlobalContrast, LoLitContrast, LocalAutoEnable,
                  LocalAutoWeit); break;
                  }
                  case 'e': {
